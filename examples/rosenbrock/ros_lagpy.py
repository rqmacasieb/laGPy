...
X = pd.read_csv('gp_0.dv_training.csv', header = 0).drop(columns=['real_name']).values #n_tr x n_dv
y = pd.read_csv('gp_0.obs_training.csv', header= 0).drop(columns=['real_name']) #n_tr x 1
y = y['func'].values
